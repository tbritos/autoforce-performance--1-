...
export default function WhatsAppInboxView() {
  ...
  useEffect(() => {
    ...
    DataService.getWhatsAppConversation(selected.leadId).then(setMessages).catch(() => setMessages([]));
  }, [selected?.leadId]);
