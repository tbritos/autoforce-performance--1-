      ...
      framework_de_qualificacao: {
        ...
        fases: [
          ...
          },
          {
            ...
            como_conectar: {
              'dor: site lento e sem leads': 'Plataforma Autodromo foi construida especificamente para isso — sites de alta velocidade e conversao para o setor automotivo. Grupo Redencao saiu de menos de 10% para 50% das vendas pelo digital.',
              'dor: baixa integracao marketing-CRM-WhatsApp': 'Ecossistema integrado — site, CRM, WhatsApp e operacao comercial conectados. Grupo Linhares tem 70% de taxa de conexao e 20% de conversao em vendas.',
              'dor: dependencia de midia paga sem base organica': 'Grupo Carmais reduziu dependencia de midia paga e fortaleceu crescimento organico com a plataforma.',
              'dor: multiplos fornecedores sem padronizacao': 'Operacao centralizada para grupos com multiplas unidades — boleto e nota fiscal separados por CNPJ.',
            },
